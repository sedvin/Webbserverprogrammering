...
<html lang="sv">
   ...
   <body>
     <form action="index2.php" method="post">
       ...
       <tr><td>Logga in:</td><td><input type="submit" value="Logga in" onclick="return kolla(document.getElementById('username').value,document.getElementById('password').value)"></td></tr>
